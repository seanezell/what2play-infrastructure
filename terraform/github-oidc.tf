...
resource "aws_iam_role" "github_actions_role" {
  name = "what2play_githubaction_role"
    ...
    Statement = [
      {
        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = "repo:seanezell/what2play-infrastructure:ref:refs/heads/main"
          }
        }
      }
    ]
...
resource "aws_iam_role_policy" "github_actions_terraform_policy" {
  name = "what2play_githubaction_policy"
